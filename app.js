...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  times=multiply(times[0],c);
  var message = a +' and '+b+' and '+c+' sum to ' + add[0] + '.';
  var message2 = 'The product of ' + a + ' and ' + b + ' and '+ c +' is '+times[0] + '.';
 return[add[0],times[0],message,message2]
}
